...
1. Select an empty cell on the 9×9 grid.
2. Enter a number from 1 to 9.
...
4. Incorrect entries count as mistakes.
5. Use hints if you get stuck to reveal the correct value.
6. Complete the board correctly to finish the level and earn up to 3 stars.
...
Try the game here:
[https://fluffyorange.itch.io/sudoku-adventure](https://fluffyorange.itch.io/sudoku-adventure)

Watch a short demo video:
https://github.com/user-attachments/assets/fa8b6512-8e48-4ab9-bf88-fcff02e054a4
